 ...
 */
final class Version20221205091206 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__song AS SELECT id, title, length FROM song');
        ...
        $this->addSql('INSERT INTO song (id, title, length) SELECT id, title, length FROM __temp__song');
